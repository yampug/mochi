require "../generated/builtins/feather_icon_rb"
require "../generated/builtins/router/route_rb"
require "../generated/builtins/router/mochi_router_rb"
...
class RubyRewriter
  ...
  def gen_builtin_component_feather_icon() : String
    return FeatherIconBIRbFragment.get_ruby_code
  end

  def gen_builtin_mochi_router() : String
    return MochiRouterBIRbFragment.get_ruby_code
  end

  def gen_builtin_route_component() : String
    return RouteBIRbFragment.get_ruby_code
  end
